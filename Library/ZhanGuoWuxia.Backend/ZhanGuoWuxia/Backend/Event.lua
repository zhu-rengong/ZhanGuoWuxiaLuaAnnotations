...
---@field private s_Events userdata | { [System.Type]: fun(obj: ZhanGuoWuxia.Backend.Event.GameEvent) } | { [nil]: userdata }
---@field private s_EventLookups userdata | { [fun()]: fun(obj: ZhanGuoWuxia.Backend.Event.GameEvent) } | { [nil]: userdata }
